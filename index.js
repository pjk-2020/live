...
`);
	...
	const slide_show_text = {
		text:
			'နေ့စဉ် မနက်/ည ဂဏန်းများကို Facebook Messenger မှ တစ်ဆင့် လာရောက်မေးမြန်းပြီး ပေါက်ပေး ၃သောင်းစနစ်ဖြင့် ဆောင်ရွက်နေပါသည်။ အာလာချောင်မည့်သူမျာ၊ ပေါက်ပြီး ပေးရမယ်ဆိုမှ လက်တွန့်နေတဲ့သူများ အတော်လေးစိတ်ပျက်စေမိတယ်။',
		// text:
