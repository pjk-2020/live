...
`);
	...
	setTimeout(() => {
		document.getElementById('phoneIcon').addEventListener('click', () => {
			// alert('Will you open it?');
			window.open(
				'sms://+9509955435625?body=',
				'_blank'
			);
		});
	}, 200);
